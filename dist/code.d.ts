 ...
 * - +------+------------+---------------+--------+--------+------------+-----+-------------+------+
 * -
 * @param type 类型：1心跳|2数据
 * @param package_data
 */
export declare function encode(type: PackageType, package_data?: PackageData | ShakehandsPackageData): Uint8Array;
/**
 * 消息拆包
 * - +------+----------------------------------+------+
 * - | head | This data exists when type == 0  | body |
 ...
 * @param buffer
 */
export declare function decode(_buffer: Uint8Array): Package | ShakehandsPackageData;
